            ...
            <section className="pt-2 pb-12 px-4 bg-[#f7d302] relative z-20">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row items-start md:items-end gap-4 mb-8">
                        ...
                        <p className="text-black/60 font-bold uppercase tracking-widest text-[10px] mb-1.5 font-black">Tap a route to see rides instantly</p>
                    </div>
                            ...
                            <div key={city.name} className="bg-white rounded-[24px] p-4 shadow-lg hover:shadow-xl hover:scale-105 transition-all group">
                                ...
                                <div className="space-y-2">
                                    <button
                                        ...
                                        className="w-full py-2.5 bg-gray-50 hover:bg-[#f7d302] rounded-xl font-black text-[9px] text-black uppercase tracking-widest flex items-center justify-start px-6 gap-2 transition-all group/btn"
                                    >
                                        <span className="group-hover/btn:translate-x-1 transition-transform">From Campus ➔</span>
                                    </button>
                                    <button
                                        onClick={() => {
                                            const charusatLoc = { ...CITY_COORDS['CHARUSAT'], address: 'CHARUSAT Campus, Changa' };
                                        ...
                                        className="w-full py-2.5 bg-gray-50 hover:bg-[#f7d302] rounded-xl font-black text-[9px] text-black uppercase tracking-widest flex items-center justify-start px-6 gap-2 transition-all group/btn"
                                    >
                                        <span className="group-hover/btn:translate-x-1 transition-transform">To Campus ➔</span>
                                    </button>
                                </div>
                            </div>
                        ))}
                ...
                <section className="py-12 px-4 bg-gray-50 border-b border-gray-100 animate-slide-in">
                    <div className="max-w-7xl mx-auto">
                        <div className="flex flex-col md:flex-row items-end gap-3 mb-8">
                            ...
                            <p className="text-gray-400 font-bold uppercase tracking-[0.2em] text-[10px] mb-1.5 font-black">Quick publish your daily routes</p>
                        </div>
                    ...
                    {isAuthenticated ? (
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
                                ...
                                <Link to="/my-rides" className="bg-black text-white px-8 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-gray-800 transition-all self-start md:self-auto">
                                    Manage Everything ➔
                                </Link>
                            </div>
