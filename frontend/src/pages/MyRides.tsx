                ...
                <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-10 md:mb-16 gap-6 text-center md:text-left">
                    <div className="space-y-4 w-full md:w-auto">
                        <div className="flex flex-col items-center md:items-start gap-2">
                            <div className="bg-yellow-400 text-black px-4 py-1.5 rounded-full inline-block font-black text-[10px] uppercase tracking-[0.2em]">Your Journeys</div>
                            <h1 className="text-5xl sm:text-6xl font-[1000] text-black tracking-tighter leading-none">
                        ...
                        <div className="flex justify-center md:justify-start">
                            <div className="inline-flex bg-white p-1.5 rounded-3xl border border-black/5 shadow-lg">
                                {(['PUBLISHED', 'TAKEN'] as const).map(tab => (
                                    <button key={tab} onClick={() => setMainTab(tab)} className={`px-5 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all ${mainTab === tab ? 'bg-yellow-400 text-black shadow-md' : 'text-gray-400 hover:text-black hover:bg-gray-50'}`}>
                    ...
                    <div className="flex justify-center md:justify-end w-full md:w-auto">
                        <div className="bg-white p-2 rounded-[32px] flex flex-wrap justify-center gap-2 border border-black/5 shadow-xl">
                            {(['ACTIVE', 'HISTORY', 'CANCELLED'] as const).map(tab => (
                                <button key={tab} onClick={() => setActiveTab(tab)} className={`px-6 py-3 rounded-[24px] font-black text-[10px] uppercase tracking-widest transition-all ${activeTab === tab ? 'bg-black text-white shadow-xl translate-y-[-2px]' : 'text-gray-400 hover:text-black hover:bg-gray-50'}`}>
                                    {tab}
