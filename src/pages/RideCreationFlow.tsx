                ...
                {step === 1 && (
                    <div className="bg-white rounded-[48px] shadow-2xl p-10 md:p-16 border border-black/5 animate-fade-in relative">
                        ...
                        <div className="space-y-10">
                            ...
                            <div className="p-5 sm:p-8 bg-black text-white rounded-[40px] flex flex-col sm:flex-row items-center justify-between gap-6 shadow-2xl shadow-black/10">
                                <div className="flex items-center gap-4 sm:gap-6">
                                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-[#f7d302] rounded-[20px] sm:rounded-[24px] flex items-center justify-center text-2xl sm:text-3xl shadow-inner text-black flex-shrink-0">👥</div>
                                    <div>
                                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1 leading-none">Available Seats</p>
                                        <p className="text-2xl sm:text-3xl font-black tracking-tight">{seats} <span className="text-xs sm:text-sm opacity-40">Persons</span></p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 bg-white/10 p-2 rounded-[24px] w-full sm:w-auto justify-center">
                                    <button type="button" onClick={() => setSeats(Math.max(1, seats - 1))} className="w-12 h-12 flex items-center justify-center font-black hover:bg-white/20 rounded-[18px] transition-all text-xl">－</button>
                                    <span className="w-12 text-center font-black text-2xl">{seats}</span>
                                    <button type="button" onClick={() => setSeats(Math.min(6, seats + 1))} className="w-12 h-12 flex items-center justify-center font-black hover:bg-white/20 rounded-[18px] transition-all text-xl">＋</button>
                                </div>
                            </div>
