                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="group md:col-span-2">
                                ...
                                <input type="email" name="email" required className="w-full px-8 py-5 bg-gray-50 border-2 border-transparent focus:border-black focus:bg-white rounded-[24px] outline-none font-black transition-all text-xs" placeholder="ID@charusat.edu.in" onChange={handleChange} />
                        ...
                        <button
                            type="submit"
                            className="w-full bg-black text-white py-6 rounded-[28px] font-[1000] text-sm uppercase tracking-[0.25em] shadow-2xl hover:bg-[#f7d302] hover:text-black transition-all active:scale-95 group/btn mt-4"
                        >
