...
const Landing: React.FC = () => {
    ...
    // - [/] Center "Quick Commute" title and subtitle on mobile
    // - [ ] Verify changes
        ...
        <div className="min-h-screen bg-white font-sans selection:bg-yellow-200">
            ...
            <section className="pt-2 pb-12 px-4 bg-[#f7d302] relative z-20">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row items-center md:items-end gap-2 md:gap-4 mb-8 text-center md:text-left">
